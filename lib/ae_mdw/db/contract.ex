defmodule AeMdw.Db.Contract do
  ...
  @spec aex9_burn_balance(pubkey(), pubkey(), non_neg_integer()) :: :ok | :error
  def aex9_burn_balance(contract_pk, account_pk, burned_value) do
    case Database.fetch(Model.Aex9Balance, {contract_pk, account_pk}) do
      {:ok, m_aex9_balance} ->
        ...
        Database.dirty_write(Model.Aex9Balance, m_aex9_balance)
  ...
  @spec aex9_mint_balance(pubkey(), pubkey(), non_neg_integer()) :: :ok | :error
  def aex9_mint_balance(contract_pk, to_pk, minted_value) do
    with {:ok, m_aex9_balance_to} <- Database.fetch(Model.Aex9Balance, {contract_pk, to_pk}) do
      ...
      Database.dirty_write(Model.Aex9Balance, m_aex9_balance_to)
    else
      :not_found ->
        :error
    end
  ...
  @spec aex9_transfer_balance(pubkey(), pubkey(), pubkey(), non_neg_integer()) :: :ok | :error
  def aex9_transfer_balance(contract_pk, from_pk, to_pk, transfered_value) do
    with {:ok, m_aex9_balance_from} <- Database.fetch(Model.Aex9Balance, {contract_pk, from_pk}),
         {:ok, m_aex9_balance_to} <- Database.fetch(Model.Aex9Balance, {contract_pk, to_pk}) do
      ...
      Database.dirty_write(Model.Aex9Balance, m_aex9_balance_from)
      Database.dirty_write(Model.Aex9Balance, m_aex9_balance_to)
    else
      :not_found ->
        :error
